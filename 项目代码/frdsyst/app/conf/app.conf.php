...
// 		'Visit' => array ( // 访问统计拦截器
// 				'file' => 'Visit', // 文件名称 例如：testInterceptor,则file值为：test
// 				'regular' => array (
// 						'm' => '/wx/', // 如果需要拦截部分请求，可以通过正则的方式来配置。例如'c' => '/^(hello|test)$/' 则只能拦截请求中c参数为hello或者test的请求。
// 						'c' => '*',
// 						'a' => '*' 
// 				)  // 正则表达式
// 				) 
...
$InitPHP_conf ['url'] = 'http://127.0.0.1/frdsyst/';
define ('DOC_ROOT', preg_replace ('/initphp$/', '', INITPHP_PATH));
define ('BASE_PATH', $InitPHP_conf ['url']);
 ...
 */
$InitPHP_conf ['log_dir'] = InitPHP::getAppPath ('data/logs/'); // 日志目录,必须配置
/**
 * 路由访问方式
 * 1.
...
$InitPHP_conf ['db'] ['default'] [0] ['database'] = 'frdsyst'; // 数据库
$InitPHP_conf ['db'] ['default'] [0] ['charset'] = 'utf8'; // 数据库编码
$InitPHP_conf ['db'] ['default'] [0] ['pconnect'] = 0; // 是否持久链接

// $InitPHP_conf ['db'] ['default'] ['db_type'] = 0; // 0-单个服务器，1-读写分离，2-随机
// $InitPHP_conf ['db'] ['default'] [0] ['host'] = 'rdsfjesj6rze7rq1j6gggpublic.mysql.rds.aliyuncs.com'; // 主机
// $InitPHP_conf ['db'] ['default'] [0] ['username'] = 'wanzhuan'; // 数据库用户名
// $InitPHP_conf ['db'] ['default'] [0] ['password'] = 'wanzhuan'; // 数据库密码
// $InitPHP_conf ['db'] ['default'] [0] ['database'] = 'kuangzhuan'; // 数据库
// $InitPHP_conf ['db'] ['default'] [0] ['charset'] = 'utf8'; // 数据库编码
// $InitPHP_conf ['db'] ['default'] [0] ['pconnect'] = 0; // 是否持久链接


$InitPHP_conf ['db'] ['log'] ['db_type'] = 0; // 0-单个服务器，1-读写分离，2-随机
$InitPHP_conf ['db'] ['log'] [0] ['host'] = '112.74.83.198'; // 主机
$InitPHP_conf ['db'] ['log'] [0] ['username'] = 'root'; // 数据库用户名
$InitPHP_conf ['db'] ['log'] [0] ['password'] = 'root'; // 数据库密码
$InitPHP_conf ['db'] ['log'] [0] ['database'] = 'kuangzhuan'; // 数据库
$InitPHP_conf ['db'] ['log'] [0] ['charset'] = 'utf8'; // 数据库编码
$InitPHP_conf ['db'] ['log'] [0] ['pconnect'] = 0; // 是否持久链接

// test数据库配置 使用：$this->init_db('test')-> 支持读写分离，随机选择（有两个数据库）
$InitPHP_conf ['db'] ['test'] ['db_type'] = 0; // 0-单个服务器，1-读写分离，2-随机
$InitPHP_conf ['db'] ['test'] [0] ['host'] = '77.66.36.182'; // 主机
$InitPHP_conf ['db'] ['test'] [0] ['username'] = 'hive'; // 数据库用户名
$InitPHP_conf ['db'] ['test'] [0] ['password'] = '123456'; // 数据库密码
...
$InitPHP_conf ['db'] ['test1'] ['db_type'] = 0;
$InitPHP_conf ['db'] ['test1'] [0] ['host'] = '127.0.0.1'; // 主机
$InitPHP_conf ['db'] ['test1'] [0] ['username'] = 'root'; // 数据库用户名
$InitPHP_conf ['db'] ['test1'] [0] ['password'] = ''; // 数据库密码
$InitPHP_conf ['db'] ['test1'] [0] ['database'] = 'test2'; // 数据库
$InitPHP_conf ['db'] ['test1'] [0] ['charset'] = 'utf8'; // 数据库编码
$InitPHP_conf ['db'] ['test1'] [0] ['pconnect'] = 0; // 是否持久链接

define ('db_name', $InitPHP_conf ['db'] ['default'] [0] ['database']);
define ('db_host', $InitPHP_conf ['db'] ['default'] [0] ['host']);
define ('db_username', $InitPHP_conf ['db'] ['default'] [0] ['username']);
define ('db_password', $InitPHP_conf ['db'] ['default'] [0] ['password']);
define ('db_charset', $InitPHP_conf ['db'] ['default'] [0] ['charset']);
...
$InitPHP_conf ['template'] ['driver'] = 'qwt'; // 不同的模板驱动编译
...
/*
 * 网络范围表示方法： 通配符: 1.2.3.* CIDR值: 1.2.3.0/24 或 IP段: 1.2.3.0-1.2.3.255
 */
...
$InitPHP_conf ['customer'] = array (
		"user" => array ( // 可以进行分组
				"host" => array (
						"localhost" 
				), // 服务提供者所在的服务器的IP地址，一般是内网IP地址。可以填写多台服务器
