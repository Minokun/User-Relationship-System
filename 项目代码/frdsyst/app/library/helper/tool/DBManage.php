        ...
        if (! empty ( $tablename ))
        {
            ...
            while ( $record = mysql_fetch_array ( $data ) )
            {
                ...
                if (strlen ( $sql ) >= $size * 1000)
                {
                    ...
                    {
                         echo "表-" . $tablename . "-卷-" . $p . "-数据备份完成,生成备份文件 <span style='color:#f00;'>$dir$filename</span>".
                        "<a href='".BASE_PATH."/admin/index/test?type=2&t_name=".$tablename."&name=".$filename."'>下载</a>".
                        " "
                        ."<br />";
                    }
                    else
            ...
            echo "<br><a href='".BASE_PATH."/admin/index/test?type=3&t_name=".$tablename."'>删除全部</a>";
        }
        else
        { // 备份全部表
